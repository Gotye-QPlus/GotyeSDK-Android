...
public class CacheManager {
    ...
    private static boolean PUT_CACHE_ON_SDCARD = true;
    ...
    public static BlobCache getCache(Context context, String filename,
            int maxEntries, int maxBytes, int version, boolean sdcard) {
        synchronized (sCacheMap) {
            ...
            if (cache == null) {
            	new File(Configs.DATA_CACHE_FOLDER).mkdirs();
                File cacheDir = sdcard ? new File(Configs.DATA_CACHE_FOLDER)
                        : context.getCacheDir();
    ...
    public static void clear(Context context) {
        File cacheDir = PUT_CACHE_ON_SDCARD ? new File(Configs.DATA_CACHE_FOLDER)
                : context.getCacheDir();
